...
import {Button, Container, Divider, Icon, Image, Menu, Responsive, Segment} from "semantic-ui-react";
    ...
    <div className='eventPage' style={{backgroundColor:'#111', marginBottom:0, padding:0}}>
        ...
        <EventWidget {...{
            ...
            eventDetail: <Container text textAlign='justified' style={{
                ...
                <p>
                    <b style={{color:'#fae1a3'}}>Former Chin Chin Chef, David Ricardo,</b> will delight tastebuds with drinks and canapés on arrival as well as an
                ...
                <p>
                    ...
                    the <b style={{color:'#fae1a3'}}>auctioning of incredible items</b>, as well as our Keynote speaker <b style={{color:'#fae1a3'}}>Col Reynolds (OAM)</b> who will share his inspiring story of how he founded <b style={{color:'#fae1a3'}}>The Kids Cancer Project</b> 25 years ago.
                </p>
                <p>
